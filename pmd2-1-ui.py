    ...
    def record_exit():
        ...
        def confirm2():
            ...
            if result:
                ...
                cursor.execute("SELECT Entry_Time FROM Avails WHERE Vehicle_ID = ?", (vehicle_id,))
                result = cursor.fetchone()
                ...
                if ticket_exists:
                    ...
                    if payment_confirmed:
                        ...
                        cursor.execute('''
                            UPDATE Space 
                            SET Initial_ParkingCharge = NULL, Extended_ParkingCharge = NULL, Extended_ParkingTime = NULL
